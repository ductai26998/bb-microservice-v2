...
SECRET_KEY = "django-insecure-%eenk1+(40-wu6e+^e1)l5lmo(6b!xc(t4@u9x)v=$6g#jb0q8"
...
DATABASES = {
    ...
    "default": {
        ...
        "NAME": os.getenv("MYSQL_NAME", "db_web"),
...
CLOUDINARY_AVATAR_USER_FOLDER = os.getenv(
    "CLOUDINARY_AVATAR_USER_FOLDER", "baber_booking/local/avatar/"
)
CLOUDINARY_GALLERY_FOLDER = os.getenv(
    "CLOUDINARY_GALLERY_FOLDER", "baber_booking/local/gallery/"
)
